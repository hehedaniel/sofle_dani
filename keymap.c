...
[_LOWER] = LAYOUT(
    ...
    KC_ASTR,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_AMPR,  KC_LT,                            KC_LT,    KC_HASH,  KC_TILD,  KC_MINS,  KC_UNDS,  XXXXXXX,
    XXXXXXX,  KC_LPRN,  KC_RPRN,  KC_LBRC,  KC_RBRC,  KC_EXLM,                          KC_QUES,  KC_LCBR,  KC_RCBR,  KC_DQUO,  KC_SLSH,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,      XXXXXXX,  KC_PLUS,  KC_EQL,   KC_BSLS,  KC_SLSH,  XXXXXXX,  XXXXXXX,
                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MO(_RAISE),            MO(_RAISE), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,  _______,       _______,  KC_F9, KC_F10, KC_F11, KC_F12, _______, _______,
                    _______, _______, TO(_ADJUST), _______, _______,             _______, _______, KC_PSCR, KC_HOME, KC_HOME
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_ADJUST] = LAYOUT(
    ...
    TO(_QWERTY), _______, _______, _______, _______, _______, RGB_TOG,     _______, _______, _______, _______, _______, _______, QK_BOOT,
